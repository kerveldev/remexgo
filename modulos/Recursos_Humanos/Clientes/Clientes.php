                              ...
                              <div class="text-center m-t-md">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-2">  
                                                            ...
                                                            <input class="form-control" type="checkbox" id="btn_status" name="btn_status" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;">
